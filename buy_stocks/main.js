...
// ----------------------------------------
    ...
    const webRequest219 = new load.WebRequest({
        id: 219,
        url: `https://${host_0}/api/stocks/watchlist?`,
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
    ...
    const webRequest220 = new load.WebRequest({
        id: 220,
        url: `https://${host_0}/api/stocks/notinwatchlist?`,
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
    ...
    const webRequest221 = new load.WebRequest({
        id: 221,
        url: `https://${host_0}/api/stocks/watchlist/prices`,
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
    ...
    const webRequest223 = new load.WebRequest({
        id: 223,
        url: `https://${host_0}/api/stocks/portfolio/week?`,
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
    ...
    const webRequest224 = new load.WebRequest({
        id: 224,
        url: `https://${host_0}/api/stocks/portfolio?`,
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
    ...
    const webRequest225 = new load.WebRequest({
        id: 225,
        url: `https://${host_0}/api/stocks/portfolio/prices`,
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
...
// ----------------------------------------
    ...
    const webRequest228 = new load.WebRequest({
        id: 228,
        url: `https://${host_0}/api/stocks/products/${stock}`, // M
        method: "GET",
        headers: {
            "accept": "application/json, text/plain, */*",
...
//-----------------------------------------    
    ...
    const webRequest230 = new load.WebRequest({
        id: 230,
        url: `https://${host_0}/api/stocks/portfolio/buy`,
        method: "POST",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
...
//-----------------------------------------
    ...
    const webRequest240 = new load.WebRequest({
        id: 240,
        url: `https://${host_0}/api/stocks/portfolio/sell`,
        method: "POST",
        headers: {
            "accept": "application/json, text/plain, */*",
            "authorization": `Bearer ${load.extractors['token']}`,
